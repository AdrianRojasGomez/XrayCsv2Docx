...
{
    public partial class CSVtoDOCX : Form
    {
        ...
        {
            if (label5.Text.Contains("JIRA"))
            {
                label5.Text = "BAR-123456";
            }
            else
            {
        ...
        private void btnCreateEvidence_Click(object sender, EventArgs e)
        {
            ...
            })
            {
                if (saveFileDialog.ShowDialog() == DialogResult.OK)
                {
                    ...
                    MessageBox.Show("File converted Succesfully", "Success!", MessageBoxButtons.OK, MessageBoxIcon.Information);
